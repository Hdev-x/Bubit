 ...
 *
 * 개발 환경에서 내장 Tomcat으로 실행할 때는 BubitApplication.main()이 진입점이고,
...
public class ServletInitializer extends SpringBootServletInitializer {
	 ...
	 * application.sources(BubitApplication.class) →
	 * BubitApplication을 설정 소스로 지정해 @SpringBootApplication 기반으로 실행한다.
	 * ============================================================ */
	@Override
	protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
		return application.sources(BubitApplication.class);
	}
