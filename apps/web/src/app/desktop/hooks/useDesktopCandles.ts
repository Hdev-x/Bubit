...
// Desktop 차트 캔들 — 타임프레임 맵 조회 + 거래소별 로더 + 실시간 캔들 구독. DesktopApp에서 옮김 .
// 옵션 값(initialLimit 600·liveCandle)은 Desktop 고유 설정이라 여기 고정.
// 현재가·등락 기준·준비 판정은 useLivePrice가 담당한다 — 이 훅은 캔들만 돌려준다.
// loadCandles는 DesktopApp이 useCandleLoader로 만들어 넘긴다 — useLivePrice(일봉 시가)와 공유하기 위해.
