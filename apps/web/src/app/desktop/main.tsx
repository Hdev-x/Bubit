...
import './styles/desktop.css'; // 앱 셸 CSS를 화면 컴포넌트보다 먼저 로드 — 컴포넌트 옆 CSS가 뒤에 와서 원본 cascade(셸 → 화면) 유지 (수정)
import '../../shared/ui/common.css'; // 양 앱 공용 규칙(.up/.down·스켈레톤) — 셸 바로 뒤, 컴포넌트 CSS보다 앞
...
// 번갈아 바뀌었다(사용자 관찰, 콘솔 'createRoot on a container that has already been passed'). 루트는 하나만 만들어 재사용한다.
