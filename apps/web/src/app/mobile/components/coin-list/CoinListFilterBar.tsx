...
import { isMarketFilter, isSortFilter, type CoinListSheet, type MarketFilter, type SortFilter } from './types';
...
interface CoinListFilterBarProps {
  ...
  setActiveSheet: (val: CoinListSheet | null) => void;
  setProductFilter: (val: ProductFilter) => void;
  setMarketFilter: (val: MarketFilter) => void;
  setSortFilter: (val: SortFilter) => void;
    ...
    <div className="filter-bar">
      ...
      <div className="filter-right-group">
        <DropdownFilter
          ...
          onSelect={(v) => { if (isMarketFilter(v)) setMarketFilter(v); }}
        ...
        <DropdownFilter 
          ...
          onSelect={(v) => { if (isSortFilter(v)) setSortFilter(v); }}
          options={[
