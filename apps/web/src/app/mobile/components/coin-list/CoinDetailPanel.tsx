...
import type { ChartPeriod } from '../../../../chart/hooks/useCoinDetailChart';

interface CoinDetailPanelProps {
  detailOpen: boolean;
  selected: CoinTicker | undefined;
  detailDragEnabled: boolean;
  isWatched: (symbol: string) => boolean;
  logoMap: Record<string, string>;
  productFilter: ProductFilter;
  getDecimals: (ticker: CoinTicker) => number;
  chartType: 'candle' | 'line';
  chartPeriod: string;
  miniCandles: Candle[];
  toggleWatchlist: (symbol: string, e?: React.MouseEvent) => void;
  toggleChartType: () => void;
  selectChartPeriod: (period: ChartPeriod) => void;
