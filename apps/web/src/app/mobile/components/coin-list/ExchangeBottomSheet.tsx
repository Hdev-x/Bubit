...
import type { CoinListSheet } from './types';

interface ExchangeBottomSheetProps {
  activeSheet: string | null;
  exchangeFilter: string;
  exchangeOptions: { label: string; value: ExchangeId; logo: string }[];
  setActiveSheet: (val: CoinListSheet | null) => void;
  onSelectExchange: (val: ExchangeId) => void;
}
