...
import { DEFAULT_PIVOT_SETTING, DEFAULT_MA_SETTINGS, DEFAULT_BB_SETTING } from './settings';
...
// 공용 설정 타입/기본값/헬퍼는 indicators/settings에 있다. 값 re-export는 d01에서 제거(컴포넌트 파일은 컴포넌트만 export) — importer가 settings를 직접 본다.
